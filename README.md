...
4. [Joining our testnet](#joiningtestnet)
    4. 1. [Requirements](#joinrequirements)
    4. 2. [Node Setup](#nodesetup)
...
8. [How it Works](#howitworks)
    8. 1. [Project Anatomy](#anatomy)
    8. 2. [Transaction Lifecycle](#lifecycle)
    8. 3. [Interacting with a Node](#interactwithnode)
9. [Setting up multiple local nodes using docker](#multiplelocalnodes)
10. [Tutorials](#tutorials)
    10. 1. [Setup the Faucet Locally](#setupfaucet)
    10. 2. [Claiming Staking Rewards](#claimstake)
    10. 3. [Bank](#bank)
    10. 4. [Slashing](#slashing)
...
## Joining Our Testnet <a name="joining"></a>
