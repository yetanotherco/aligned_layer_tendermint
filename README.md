...
If you want to run a node on Docker, you first need to build the image by runing:

```sh
docker build . -t alignedlayerd_i
```

Then go into `docker` directory and run the following command to setup the node:
