...
const (
	...
	opWeightMsgVerifykimchi = "op_weight_msg_verifykimchi"
	// TODO: Determine the simulation weight value
	defaultWeightMsgVerifykimchi int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgVerifykimchi int
	simState.AppParams.GetOrGenerate(opWeightMsgVerifykimchi, &weightMsgVerifykimchi, nil,
		func(_ *rand.Rand) {
			weightMsgVerifykimchi = defaultWeightMsgVerifykimchi
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgVerifykimchi,
		verificationsimulation.SimulateMsgVerifykimchi(am.accountKeeper, am.bankKeeper, am.keeper),
	))
...
func (am AppModule) ProposalMsgs(simState module.SimulationState) []simtypes.WeightedProposalMsg {
	return []simtypes.WeightedProposalMsg{
		...
		simulation.NewWeightedProposalMsg(
			opWeightMsgVerifykimchi,
			defaultWeightMsgVerifykimchi,
			func(r *rand.Rand, ctx sdk.Context, accs []simtypes.Account) sdk.Msg {
				verificationsimulation.SimulateMsgVerifykimchi(am.accountKeeper, am.bankKeeper, am.keeper)
				return nil
			},
