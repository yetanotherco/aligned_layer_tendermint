...
var fileDescriptor_4e754d0b62f92212 = []byte{
	...
	0x94, 0x5a, 0x5c, 0x90, 0x9f, 0x57, 0x9c, 0xaa, 0x14, 0xc9, 0xc5, 0xe9, 0x5b, 0x9c, 0x1e, 0x96,
	...
	,
}
...
func (m *MsgVerify) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pw) > 0 {
		i -= len(m.Pw)
		copy(dAtA[i:], m.Pw)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Pw)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Proof) > 0 {
