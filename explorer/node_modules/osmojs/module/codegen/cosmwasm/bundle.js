...
(function (_cosmwasm) {
  ...
  (function (_wasm) {
    const v1 = _wasm.v1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _45), _46), _47), _48), _49), _50), _194), _195), _196), _197), _198);
  })(wasm || (wasm = _cosmwasm.wasm || (_cosmwasm.wasm = {})));

  const ClientFactory = _cosmwasm.ClientFactory = _objectSpread(_objectSpread(_objectSpread({}, _289), _290), _291);
})(cosmwasm || (cosmwasm = {}));