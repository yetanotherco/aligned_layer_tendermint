...
(function (_cosmos) {
  ...
  (function (_authz) {
    const v1beta1 = _authz.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _2), _3), _4), _5), _6), _157), _164), _171), _179), _187);
  })(authz || (authz = _cosmos.authz || (_cosmos.authz = {})));

  let bank;

  (function (_bank) {
    const v1beta1 = _bank.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _7), _8), _9), _10), _11), _158), _165), _172), _180), _188);
  ...
  (function (_base) {
    ...
    (function (_abci) {
      const v1beta1 = _abci.v1beta1 = _objectSpread({}, _12);
    })(abci || (abci = _base.abci || (_base.abci = {})));

    let query;

    (function (_query) {
      const v1beta1 = _query.v1beta1 = _objectSpread({}, _13);
    })(query || (query = _base.query || (_base.query = {})));

    let reflection;

    (function (_reflection) {
      const v2alpha1 = _reflection.v2alpha1 = _objectSpread({}, _14);
    })(reflection || (reflection = _base.reflection || (_base.reflection = {})));

    const v1beta1 = _base.v1beta1 = _objectSpread({}, _15);
  })(base || (base = _cosmos.base || (_cosmos.base = {})));

  let crypto;

  (function (_crypto) {
    const ed25519 = _crypto.ed25519 = _objectSpread({}, _16);

    let hd;

    (function (_hd) {
      const v1 = _hd.v1 = _objectSpread({}, _17);
    })(hd || (hd = _crypto.hd || (_crypto.hd = {})));

    let keyring;

    (function (_keyring) {
      const v1 = _keyring.v1 = _objectSpread({}, _18);
    })(keyring || (keyring = _crypto.keyring || (_crypto.keyring = {})));

    const multisig = _crypto.multisig = _objectSpread({}, _19);

    const secp256k1 = _crypto.secp256k1 = _objectSpread({}, _20);

    const secp256r1 = _crypto.secp256r1 = _objectSpread({}, _21);
  })(crypto || (crypto = _cosmos.crypto || (_cosmos.crypto = {})));

  let distribution;

  (function (_distribution) {
    const v1beta1 = _distribution.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _22), _23), _24), _25), _159), _166), _173), _181), _189);
  })(distribution || (distribution = _cosmos.distribution || (_cosmos.distribution = {})));

  let gov;

  (function (_gov) {
    const v1 = _gov.v1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _26), _27), _28), _29), _160), _167), _174), _182), _190);

    const v1beta1 = _gov.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _30), _31), _32), _33), _161), _168), _175), _183), _191);
  })(gov || (gov = _cosmos.gov || (_cosmos.gov = {})));

  let staking;

  (function (_staking) {
    const v1beta1 = _staking.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _34), _35), _36), _37), _38), _162), _169), _176), _184), _192);
  ...
  (function (_tx) {
    ...
    (function (_signing) {
      const v1beta1 = _signing.v1beta1 = _objectSpread({}, _39);
    })(signing || (signing = _tx.signing || (_tx.signing = {})));

    const v1beta1 = _tx.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _40), _41), _177), _185);
  })(tx || (tx = _cosmos.tx || (_cosmos.tx = {})));

  let upgrade;

  (function (_upgrade) {
    const v1beta1 = _upgrade.v1beta1 = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _42), _43), _44), _163), _170), _178), _186), _193);
  })(upgrade || (upgrade = _cosmos.upgrade || (_cosmos.upgrade = {})));

  const ClientFactory = _cosmos.ClientFactory = _objectSpread(_objectSpread(_objectSpread({}, _286), _287), _288);
})(cosmos || (cosmos = {}));