  ...
  "/osmosis.gamm.poolmodels.balancer.v1beta1.MsgMigrateSharesToFullRangeConcentratedPosition": {
    ...
    toAmino: function toAmino(_ref3) {
      var sender = _ref3.sender,
          sharesToMigrate = _ref3.sharesToMigrate,
          poolIdEntering = _ref3.poolIdEntering;
      return {
        sender: sender,
        shares_to_migrate: {
          denom: sharesToMigrate.denom,
          amount: _helpers.Long.fromValue(sharesToMigrate.amount).toString()
        },
    ...
    fromAmino: function fromAmino(_ref4) {
      var sender = _ref4.sender,
          shares_to_migrate = _ref4.shares_to_migrate,
          pool_id_entering = _ref4.pool_id_entering;
      return {
        sender: sender,
        sharesToMigrate: {
        ...
        poolIdEntering: _helpers.Long.fromString(pool_id_entering)
      };
    }
  }
};
