...
function createBaseMsgMigrateSharesToFullRangeConcentratedPosition() {
  return {
    ...
    poolIdEntering: _helpers.Long.UZERO
  };
}
...
var MsgMigrateSharesToFullRangeConcentratedPosition = {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.poolIdEntering = reader.uint64();
          break;
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.poolIdEntering = object.poolIdEntering !== undefined && object.poolIdEntering !== null ? _helpers.Long.fromValue(object.poolIdEntering) : _helpers.Long.UZERO;
    return message;
  }
};
