...
declare const codeToThemedTokens: (code: string, options: _shikijs_core.RequireKeys<_shikijs_core.CodeToThemedTokensOptions<BundledLanguage, BundledTheme>, "lang" | "theme">) => Promise<_shikijs_core.ThemedToken[][]>;
