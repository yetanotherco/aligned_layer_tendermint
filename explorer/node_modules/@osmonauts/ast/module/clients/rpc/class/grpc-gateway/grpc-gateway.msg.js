...
const getFetchReqArgs = (name, packageImport) => {
  ...
  const argTemplateLiteral = t.templateLiteral([t.templateElement({
...
const grpcGatewayMethodDefinition = (name, svc, packageImport, leadingComments) => {
  ...
  // method's body
  const body = t.blockStatement([t.returnStatement(t.callExpression(t.memberExpression(t.identifier('fm'), t.identifier('fetchReq')), fetchArgs))]);
