...
const rpcExtensionMethod = (name, svc) => {
...
export const createRpcQueryExtension = (context, service) => {
  ...
  return t.exportNamedDeclaration(t.variableDeclaration('const', [t.variableDeclarator(t.identifier('createRpcQueryExtension'), t.arrowFunctionExpression([identifier('base', t.tsTypeAnnotation(t.tsTypeReference(t.identifier('QueryClient'))))], t.blockStatement([t.variableDeclaration('const', [t.variableDeclarator(t.identifier('rpc'), t.callExpression(t.identifier('createProtobufRpcClient'), [t.identifier('base')]))]),
  //////
  t.variableDeclaration('const', [t.variableDeclarator(t.identifier('queryService'), t.newExpression(t.identifier(getRpcClassName(service)), [t.identifier('rpc')]))]), t.returnStatement(t.objectExpression([...methods]))])))]));
};