...
export const toAminoJSONMethod = (context, name, proto) => {
  ...
  if (!body.length) {
    ...
    [].push.apply(body, [t.variableDeclaration('const', [t.variableDeclarator(identifier('obj', t.tsTypeAnnotation(t.tsAnyKeyword())), t.objectExpression([]))]), ...fields,
    // RETURN 
    t.returnStatement(t.identifier('obj'))]);
  }
  return objectMethod('method', t.identifier('toAmino'), [identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))))], t.blockStatement(body), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(AminoTypeName))));
};
export const toAminoMsgMethod = (context, name, proto) => {
  ...
  return objectMethod('method', t.identifier('toAminoMsg'), [identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(TypeName))))], t.blockStatement(body), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(ReturnType))));
};