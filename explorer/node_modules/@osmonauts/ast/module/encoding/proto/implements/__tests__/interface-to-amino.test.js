...
describe('ProposalContent', () => {
  ...
  it('ProposalContent helper', () => {
    expectCode(createInterfaceToAminoHelper(txContext, 'ProposalContentI_toAmino', typeMap['ProposalContentI']));
  });
  it('ProposalContent', () => {
    expectCode(createInterfaceToAmino(txContext, txRef, 'ProposalContentI'));
  });
});
describe('MsgCreateValidator', () => {
  ...
  it('MsgCreateValidator', () => {
    expectCode(createInterfaceToAmino(ctx, ref, 'cosmos.crypto.PubKey'));
  });
});