...
describe('PoolI', () => {
  ...
  it('PoolI', () => {
    expectCode(createInterfaceDecoderHelper(queryContext, 'PoolI_InterfaceDecoder', typeMap['PoolI']));
  });
  it('objects', () => {
    expectCode(createObjectWithMethods(queryContext, 'QueryPoolsResponse', getNestedProto(queryRef.traversed).QueryPoolsResponse));
  });
});