...
describe('ProposalContent', () => {
  ...
  it('ProposalContent helper', () => {
    expectCode(createInterfaceFromAminoHelper(txContext, 'ProposalContentI_fromAmino', typeMap['ProposalContentI']));
  });
  it('ProposalContent', () => {
    expectCode(createInterfaceFromAmino(txContext, txRef, 'ProposalContentI'));
  });
});
describe('MsgCreateValidator', () => {
  ...
  it('MsgCreateValidator', () => {
    expectCode(createInterfaceFromAmino(ctx, ref, 'cosmos.crypto.PubKey'));
  });
});