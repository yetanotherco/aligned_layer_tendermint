...
export const fromPartialMethod = (context, name, proto) => {
  ...
  return objectMethod('method', t.identifier('fromPartial'), [param], t.blockStatement([
  // init 
  t.variableDeclaration('const', [t.variableDeclarator(t.identifier('message'), t.callExpression(t.identifier(getBaseCreateTypeFuncName(name)), []))]), ...fields,
  // RETURN 
