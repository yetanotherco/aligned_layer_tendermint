...
import { createProtoType, createProtoInterfaceEncodedType } from '..';
...
describe('cosmos/gov/v1beta1/tx.proto', () => {
  ...
  it('createProtoType', () => {
    expectCode(createProtoType(context, 'MsgSubmitProposal', getNestedProto(ref.traversed).MsgSubmitProposal));
  });
  it('createProtoInterfaceEncodedType', () => {
    expectCode(createProtoInterfaceEncodedType(context, 'MsgSubmitProposal', getNestedProto(ref.traversed).MsgSubmitProposal));
  });
});