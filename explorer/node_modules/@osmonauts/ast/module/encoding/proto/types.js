...
export const GOOGLE_TYPES = ['google.protobuf.Timestamp', 'google.protobuf.Duration', 'google.protobuf.Any'];
...
export const getFieldOptionalityForDefaults = (context, field, isOneOf) => {
  ...
  return isOneOf || useOptionalNullable && field?.options?.['(gogoproto.nullable)'] ||
