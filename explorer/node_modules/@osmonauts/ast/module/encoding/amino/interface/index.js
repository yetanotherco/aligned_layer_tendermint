...
export const makeAminoTypeInterface = ({
  ...
  const annotation = context.options.aminoEncoding.useRecursiveV2encoding ? t.tsTypeAnnotation(t.tsTypeReference(t.identifier(TypeName + 'Amino'))) : t.tsTypeAnnotation(t.tsTypeLiteral(fields.map(({
    field
  }) => field)));
