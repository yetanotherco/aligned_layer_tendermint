...
store.traverseAll();
it('createScopedRpcHookFactory', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
  var context;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _testUtils.expectCode)(t.program((0, _scopedBundle.createScopedRpcHookFactory)(context, {
            cosmos: {
              bank: {
