...
var notUndefinedSetValue = function notUndefinedSetValue(messageProp, objProp, expr) {
...
var toJSON = {
  ...
  "long": function long(args) {
    ...
    return notUndefinedSetValue(messageProp, objProp, t.callExpression(t.memberExpression(t.logicalExpression('||', t.memberExpression(t.identifier('message'), t.identifier(messageProp)), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOneOf)), t.identifier('toString')), []));
  },
  ...
  bytes: function bytes(args) {
    ...
    if (args.isOptional) {
      ...
      // message.queryData !== undefined && (obj.queryData = base64FromBytes(message.queryData !== undefined ? message.queryData : new Uint8Array()));
      expr = t.callExpression(t.identifier('base64FromBytes'), [t.conditionalExpression(t.binaryExpression('!==', t.memberExpression(t.identifier('message'), t.identifier(messageProp)), t.identifier('undefined')), t.memberExpression(t.identifier('message'), t.identifier(messageProp)), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOneOf))]);
    }
