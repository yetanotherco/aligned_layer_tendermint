...
var _fromAmino = require("../from-amino");
...
describe('ProposalContent', function () {
  ...
  it('ProposalContent helper', function () {
    (0, _testUtils.expectCode)((0, _fromAmino.createInterfaceFromAminoHelper)(txContext, 'ProposalContentI_fromAmino', typeMap['ProposalContentI']));
  });
  it('ProposalContent', function () {
    (0, _testUtils.expectCode)((0, _fromAmino.createInterfaceFromAmino)(txContext, txRef, 'ProposalContentI'));
  });
});
describe('MsgCreateValidator', function () {
  ...
  it('MsgCreateValidator', function () {
    (0, _testUtils.expectCode)((0, _fromAmino.createInterfaceFromAmino)(ctx, ref, 'cosmos.crypto.PubKey'));
  });
});