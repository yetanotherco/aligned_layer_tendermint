...
describe('PageRequest', function () {
  ...
  it('interface', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'PageRequest', (0, _protoParser.getNestedProto)(ref.traversed).PageRequest));
  });
});
describe('PageResponse', function () {
  ...
  var context = new _context.ProtoParseContext(ref, store, store.options);
  it('interface', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'PageResponse', (0, _protoParser.getNestedProto)(ref.traversed).PageResponse));
  });
});
describe('cosmos/auth/v1beta1/auth.proto', function () {
  ...
  it('BaseAccount', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'BaseAccount', (0, _protoParser.getNestedProto)(ref.traversed).BaseAccount));
  });
});
describe('GenesisState', function () {
  ...
  var context = new _context.ProtoParseContext(ref, store, store.options);
  it('interface', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'GenesisState', (0, _protoParser.getNestedProto)(ref.traversed).GenesisState));
  });
});
describe('cosmos/authz/v1beta1/authz.proto', function () {
  ...
  var context = new _context.ProtoParseContext(ref, store, store.options);
  it('Grant', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'Grant', (0, _protoParser.getNestedProto)(ref.traversed).Grant));
  });
  it('GrantAuthorization', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'GrantAuthorization', (0, _protoParser.getNestedProto)(ref.traversed).GrantAuthorization));
  });
});
describe('cosmos/authz/v1beta1/query.proto', function () {
  ...
  it('QueryGrantsRequest', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'QueryGrantsRequest', (0, _protoParser.getNestedProto)(ref.traversed).QueryGrantsRequest));
  });
});
describe('confio/proofs.proto', function () {
  ...
  it('ExistenceProof', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'ExistenceProof', (0, _protoParser.getNestedProto)(ref.traversed).ExistenceProof));
  });
});
describe('osmosis/gamm/v1beta1/tx.proto', function () {
  ...
  it('MsgJoinPool', function () {
    (0, _testUtils.expectCode)((0, _amino.createAminoType)(context, 'MsgJoinPool', (0, _protoParser.getNestedProto)(ref.traversed).MsgJoinPool));
  });
});