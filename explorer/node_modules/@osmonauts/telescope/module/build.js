import { AminoParseContext, createAminoConverter, createCreateProtoType, createObjectWithMethods, createProtoEnum, createProtoEnumToJSON, createProtoEnumFromJSON, createProtoType, createProtoInterfaceEncodedType, createProtoTypeType, createSDKType, createAminoType, createAminoTypeType, createEnumSDKType, createEnumAminoType, makeAminoTypeInterface, GenericParseContext, ProtoParseContext, createTypeRegistry, createRegistryLoader,
// helper
createHelperObject, createInterfaceDecoder, createInterfaceFromAmino, createInterfaceToAmino } from '@osmonauts/ast';
    ...
    if (this.options.interfaces.enabled) {
      ...
      if (interfaces.length) {
        interfaces.forEach(interfaceName => {
          ...
          if (this.options.aminoEncoding.enabled && this.options.aminoEncoding.useRecursiveV2encoding) {
