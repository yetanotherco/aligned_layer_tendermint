...
exports.getRoot = exports.getRelativePath = exports.fixlocalpaths = exports.UTIL_HELPERS = exports.UTILS = void 0;
var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));
var _path = require("path");
var _commonCreateBundle = require("./common-create-bundle");
Object.keys(_commonCreateBundle).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _commonCreateBundle[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _commonCreateBundle[key];
    }
  });
});
...
exports.UTILS = UTILS;
var UTIL_HELPERS = ['__helpers__', '__extern__', '__react-query__', '__mobx__', '__pinia-endpoint__', '__grpc-gateway__', '__grpc-web__'];
exports.UTIL_HELPERS = UTIL_HELPERS;
var fixlocalpaths = function fixlocalpaths(imports) {
  return imports.map(function (imp) {
    return _objectSpread(_objectSpread({}, imp), {}, {
      path: UTIL_HELPERS.includes(imp.path) || imp.path.startsWith('.') || imp.path.startsWith('@') ? imp.path : "./".concat(imp.path)
    });
  });
};
