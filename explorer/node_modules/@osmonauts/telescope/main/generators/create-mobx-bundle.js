...
var plugin = function plugin(builder) {
  ...
  var obj = {};
  var bundlerFiles = builder.stateManagers["mobx"];
  ...
  (0, _utils.commonBundlePlugin)(builder, 'stores.ts', obj, function (context, obj) {
    // generate code for createRpcQueryHooks and imports of related packages.
    return (0, _ast.createMobxQueryFactory)(context, obj);
  });
};
