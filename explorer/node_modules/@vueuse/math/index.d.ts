...
import { MaybeComputedRef, MaybeReadonlyRef, MaybeRef, ArgumentsType, Reactified } from '@vueuse/shared';
...
declare function useClamp(value: MaybeReadonlyRef<number>, min: MaybeComputedRef<number>, max: MaybeComputedRef<number>): ComputedRef<number>;
