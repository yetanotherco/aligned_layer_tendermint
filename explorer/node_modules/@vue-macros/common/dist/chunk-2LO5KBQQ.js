...
function babelParse(code, lang, options = {}) {
  const plugins = [];
  if (_chunk72SYRX76js.isTs.call(void 0, lang)) {
    plugins.push("typescript");
    if (_chunk2JGI6V7Cjs.REGEX_LANG_JSX.test(lang))
      plugins.push("jsx");
  } else
    plugins.push("jsx");
